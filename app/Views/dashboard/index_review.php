    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-title"><i class="fas fa-star mr-2"></i>จัดการข้อมูลรีวิว</h4>
...
<script>
    ...
    function load_modal(action, data_encode) {
        ...
        switch (action) {
            case 'Create':
                $("#modal-title").html('<i class="fas fa-plus-circle mr-2"></i>เพิ่มรีวิว');
                $('#url_route').val('dashboard/review/create');
                check_action = 'Create';
                break;
            case 'Update':
                $("#modal-title").html('<i class="fas fa-edit mr-2"></i>แก้ไขรีวิว');
