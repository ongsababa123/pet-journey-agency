...
$routes->group('dashboard/',  ['namespace' => 'App\Controllers\Dashboard', 'filter' => 'AuthGuard'], function ($routes) {
    ...
    $routes->get('review/delete/(:num)', 'ReviewDataController::delete_cover/$1'); //delete review
    ...
    $routes->post('contact/update/(:num)', 'ContactDataController::update_contact/$1'); //update contact
    //------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $routes->get('partner/delete/(:num)', 'PartnerDataController::delete_partner/$1'); //delete partner
    $routes->post('partner/create/(:num)', 'PartnerDataController::create_partner/$1'); //create partner data
    $routes->post('partner/update/(:num)', 'PartnerDataController::update_partner/$1'); //update partner data
    //------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $routes->post('service/update/(:num)', 'ServiceDataController::update_service/$1'); //update service data
    //------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $routes->post('animal/update/(:num)', 'ServiceDataController::update_animal/$1'); //update animal
    $routes->get('animal/changestatus/(:num)/(:num)', 'ServiceDataController::change_status_animal/$1/$2'); //change status animal
    $routes->get('animal/delete/(:num)', 'ServiceDataController::delete_animal/$1'); //delete animal
    //------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $routes->post('performanceteam/update/(:num)', 'PerformanceTeamController::update_performance/$1'); //update performance
    //------------------------------------------------------------------------------------------------------------------------------------//
...
$routes->group('dashboard/homepage/', ['namespace' => 'App\Controllers\Dashboard\Homepage', 'filter' => 'AuthGuard'], function ($routes) {
    ...
    $routes->get('cover/delete/(:num)', 'HomePage_ConverController::delete_cover/$1'); //delete cover
    ...
    $routes->post('about/update/(:num)', 'HomePage_AboutController::update_about_homepage/$1'); //update about
    //------------------------------------------------------------------------------------------------------------------------------------//
});
...
$routes->group('dashboard/aboutpage/', ['namespace' => 'App\Controllers\Dashboard\Aboutpage', 'filter' => 'AuthGuard'], function ($routes) {
    ...
    $routes->post('abouthead/update/(:num)', 'AboutPage_HeadController::update_about_head/$1'); //update about head
    //------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $routes->get('aboutteam/delete/(:num)', 'AboutPage_TeamController::delete_team/$1'); //delete team
    $routes->get('aboutteam/changestatus/(:num)/(:num)', 'AboutPage_TeamController::change_status_team/$1/$2'); //change status team
    $routes->post('aboutteam/update/(:num)', 'AboutPage_TeamController::update_about_team/$1'); //update about team
    ...
    $routes->get('aboutmore/delete/(:num)', 'AboutPage_MoreController::delete_more/$1'); //delete more
    //------------------------------------------------------------------------------------------------------------------------------------//
    $routes->post('aboutmore/create', 'AboutPage_MoreController::create_about_more'); //create about more
    $routes->post('aboutmore/update/(:num)', 'AboutPage_MoreController::update_about_more/$1'); //update about more
    //------------------------------------------------------------------------------------------------------------------------------------//
});
